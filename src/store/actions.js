...
export const checkoperationsid1_get_patient_id_read = id => ({
  type: types.CHECKOPERATIONSID1_GET_PATIENT_ID_READ,
  id
})

export const checkoperationsid1_get_patient_id_readSucceeded = response => ({
  type: types.CHECKOPERATIONSID1_GET_PATIENT_ID_READ_SUCCEEDED,
  response
})

export const checkoperationsid1_get_patient_id_readFailed = error => ({
  type: types.CHECKOPERATIONSID1_GET_PATIENT_ID_READ_FAILED,
  error
})
