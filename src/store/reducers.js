...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.CHECKOPERATIONID13_GET_BANANA_ID_READ:
    case types.CHECKOPERATIONID13_GET_BANANA_ID_READ_SUCCEEDED:
    case types.CHECKOPERATIONID13_GET_BANANA_ID_READ_FAILED:
    ...
    case types.CHECKOPERATIONSID4_GET_PATIENT_ID_READ:
    case types.CHECKOPERATIONSID4_GET_PATIENT_ID_READ_SUCCEEDED:
    case types.CHECKOPERATIONSID4_GET_PATIENT_ID_READ_FAILED:
    case types.CHECKOPERATIONSID3_GET_PATIENT_ID_READ:
    case types.CHECKOPERATIONSID3_GET_PATIENT_ID_READ_SUCCEEDED:
    case types.CHECKOPERATIONSID3_GET_PATIENT_ID_READ_FAILED:
    case types.CHECKOPERATIONSID2_GET_PATIENT_ID_READ:
    case types.CHECKOPERATIONSID2_GET_PATIENT_ID_READ_SUCCEEDED:
    case types.CHECKOPERATIONSID2_GET_PATIENT_ID_READ_FAILED:
    case types.CHECKOPERATIONSID1_GET_PATIENT_ID_READ:
    case types.CHECKOPERATIONSID1_GET_PATIENT_ID_READ_SUCCEEDED:
    case types.CHECKOPERATIONSID1_GET_PATIENT_ID_READ_FAILED:
