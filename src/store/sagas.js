...
function* checkoperationid11_get_apple_id_readWorker(action) {
  try {
    const result = yield call(
      apiService.checkoperationid11_get_apple_id_read,
      action
    )
    yield put(actions.checkoperationid11_get_apple_id_readSucceeded(result))
  } catch (err) {
    yield put(actions.checkoperationid11_get_apple_id_readFailed(err))
  }
}
function* checkoperationid11_get_apple_id_readWatcher() {
  yield takeEvery(
    types.CHECKOPERATIONID11_GET_APPLE_ID_READ,
    checkoperationid11_get_apple_id_readWorker
  )
}
function* checkoperationidplugin1_get_orange_id_readWorker(action) {
  try {
    const result = yield call(
      apiService.checkoperationidplugin1_get_orange_id_read,
      action
    )
    yield put(
      actions.checkoperationidplugin1_get_orange_id_readSucceeded(result)
    )
  } catch (err) {
    yield put(actions.checkoperationidplugin1_get_orange_id_readFailed(err))
  }
}
function* checkoperationidplugin1_get_orange_id_readWatcher() {
  yield takeEvery(
    types.CHECKOPERATIONIDPLUGIN1_GET_ORANGE_ID_READ,
    checkoperationidplugin1_get_orange_id_readWorker
  )
}
function* checkoperationsid4_get_patient_id_readWorker(action) {
  try {
    const result = yield call(
      apiService.checkoperationsid4_get_patient_id_read,
      action
    )
    yield put(actions.checkoperationsid4_get_patient_id_readSucceeded(result))
  } catch (err) {
    yield put(actions.checkoperationsid4_get_patient_id_readFailed(err))
  }
}
function* checkoperationsid4_get_patient_id_readWatcher() {
  yield takeEvery(
    types.CHECKOPERATIONSID4_GET_PATIENT_ID_READ,
    checkoperationsid4_get_patient_id_readWorker
  )
}
...
function* checkoperationsid2_get_patient_id_readWorker(action) {
  try {
    const result = yield call(
      apiService.checkoperationsid2_get_patient_id_read,
      action
    )
    yield put(actions.checkoperationsid2_get_patient_id_readSucceeded(result))
  } catch (err) {
    yield put(actions.checkoperationsid2_get_patient_id_readFailed(err))
  }
}
function* checkoperationsid2_get_patient_id_readWatcher() {
  yield takeEvery(
    types.CHECKOPERATIONSID2_GET_PATIENT_ID_READ,
    checkoperationsid2_get_patient_id_readWorker
  )
}
function* checkoperationsid1_get_patient_id_readWorker(action) {
  try {
    const result = yield call(
      apiService.checkoperationsid1_get_patient_id_read,
      action
    )
    yield put(actions.checkoperationsid1_get_patient_id_readSucceeded(result))
  } catch (err) {
    yield put(actions.checkoperationsid1_get_patient_id_readFailed(err))
  }
}
function* checkoperationsid1_get_patient_id_readWatcher() {
  yield takeEvery(
    types.CHECKOPERATIONSID1_GET_PATIENT_ID_READ,
    checkoperationsid1_get_patient_id_readWorker
  )
}
